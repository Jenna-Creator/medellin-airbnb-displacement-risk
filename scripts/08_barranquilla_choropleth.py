...
m = folium.Map(location=[10.9685, -74.7813], zoom_start=12, tiles='cartodbpositron')

folium.Choropleth(
    geo_data=merged,
    data=merged,
    columns=['barrio', 'displacement_risk_index'],
...
folium.GeoJson(
    ...
    tooltip=folium.GeoJsonTooltip(
        fields=['barrio', 'localidad', 'displacement_risk_index'],
        aliases=['Barrio:', 'Localidad:', 'Risk Index:'],
        localize=True,
    ),
).add_to(m)
